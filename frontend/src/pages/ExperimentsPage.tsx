...
export default function ExperimentsPage() {
    ...
    const columns: ColumnsType<MLOpsRun> = [
        ...
        },
        {
            ...
            key: 'val_auroc',
            width: 100,
            render: (_: unknown, r: MLOpsRun) => fmtMetric(r.metrics.val_auroc),
            sorter: (a, b) => (a.metrics.val_auroc ?? 0) - (b.metrics.val_auroc ?? 0),
        },
        {
            title: 'Test AUROC',
            key: 'test_auroc',
            width: 100,
            render: (_: unknown, r: MLOpsRun) => fmtMetric(r.metrics.test_auroc),
            sorter: (a, b) => (a.metrics.test_auroc ?? 0) - (b.metrics.test_auroc ?? 0),
        },
        {
            title: 'Test AUPRC',
            key: 'test_auprc',
            width: 100,
            render: (_: unknown, r: MLOpsRun) => fmtMetric(r.metrics.test_auprc),
            sorter: (a, b) => (a.metrics.test_auprc ?? 0) - (b.metrics.test_auprc ?? 0),
        },
        {
            title: 'Sensitivity',
            key: 'test_sensitivity',
            width: 110,
            render: (_: unknown, r: MLOpsRun) => fmtMetric(r.metrics.test_sensitivity),
            sorter: (a, b) => (a.metrics.test_sensitivity ?? 0) - (b.metrics.test_sensitivity ?? 0),
        },
    ];
